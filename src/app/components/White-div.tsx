...
export default function WhiteDiv() {
  return (
    <div className="w-full h-auto mt-[3810px] px-4 lg:px-0">
      <div className="w-full max-w-[1440px] flex flex-col lg:flex-row gap-[30px]">
        {/* Image Section */}
        <div className="relative w-full h-[400px] lg:h-[682px] flex justify-center">
          <Image
            src={couples}
            alt="couple"
        ...
        {/* Text Section */}
        <div className="w-full flex flex-col gap-[20px] justify-center items-center lg:items-start text-center lg:text-left mt-[20px] lg:mt-0">
